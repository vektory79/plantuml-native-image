...
//            initAtRuntime(a, InputStream.class);
            ...
            //registerLookAndFeel(MetalLookAndFeel.class);
    ...
    private void registerLookAndFeel(Class<? extends BasicLookAndFeel> clazz) throws IllegalAccessException, InstantiationException {
        UIDefaults defaults = clazz.newInstance().getDefaults();
